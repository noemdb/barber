...
> ## ⚠️ DOCUMENTO OBSOLETO (contexto SAEFL/Laravel)
>
> Este documento es la **especificación original** de alcance amplio, redactada para **SAEFL (sistema escolar) sobre Laravel 10 / Livewire / MariaDB**. Fue superado en dos etapas:
...
> 2. **`SPEC-BINNACLE-001.md` es el spec normativo vigente**, ahora portado al contexto de **BarberService (Next.js 16 / Prisma 7 / PostgreSQL)** — ver Anexo C de ese spec para el mapeo de conceptos.
>
> Se conserva solo como registro histórico del alcance completo (objetivos, timeline, retención, riesgos) del sistema escolar. **No usar como referencia de implementación.** Cualquier discrepancia con `SPEC-BINNACLE-001.md` se resuelve a favor de este último.
