...
> ## ⚠️ DOCUMENTO SUPERSEDIDO (contexto SAEFL/Laravel)
>
> Esta revisión técnica fue **absorbida e integrada** en **`SPEC-BINNACLE-001.md`**, que es el spec normativo vigente, ahora portado al contexto de **BarberService (Next.js 16 / Prisma 7 / PostgreSQL)** — ver Anexo C de ese spec. Sus decisiones de arquitectura (ADR-001 a ADR-005, contrato `Auditable`, trigger de inmutabilidad, flujo único de escritura) se conservan como referencia conceptual, mapeadas al equivalente Next.js.
>
